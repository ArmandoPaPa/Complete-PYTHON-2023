...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Armando PaPa\Desktop\MaM+10M\Udemy\Python\06_APIs'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Armando PaPa\Desktop\MaM+10M\Udemy\Python\06_APIs\Scripts\deactivate.nu'
