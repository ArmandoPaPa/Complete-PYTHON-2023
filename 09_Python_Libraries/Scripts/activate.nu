...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Armando PaPa\Desktop\MaM+10M\Udemy\Python\09_Python_Libraries'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Armando PaPa\Desktop\MaM+10M\Udemy\Python\09_Python_Libraries\Scripts\deactivate.nu'
